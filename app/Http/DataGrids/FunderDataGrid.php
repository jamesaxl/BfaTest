...
use App\Http\Resources\Funder\FunderResource;
use App\Model\Funder;
use Illuminate\Http\Request;

class FunderDataGrid extends QueryDataGrid
{
    protected $resource = FunderResource::class;
    ...
    {
        return Funder::query()->with('organization.country',
                                        'organization.city',
