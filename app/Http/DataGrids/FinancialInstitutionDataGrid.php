...
use App\Http\Resources\Consultant\FinancialInstitutionResource;
use App\Model\FinancialInstitution;
use Illuminate\Http\Request;

class FinancialInstitutionDataGrid extends QueryDataGrid
{
    protected $resource = FinancialInstitutionResource::class;
    ...
    protected function columns()
    {
        $this->column('id')
            ->column('photo_path')
            ->column('name')
            ->column('financial_institution_type');
    }
    ...
    {
        return FinancialInstitution::query()->with('organization.country',
                                        'organization.city',
