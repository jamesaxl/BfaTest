...
use App\Http\Resources\KpiIndicator\KpiIndicatorResource;
use App\Model\KpiIndicator;
use Illuminate\Http\Request;

class KpiIndicatorDataGrid extends QueryDataGrid
{
    protected $resource = KpiIndicatorResource::class;
    ...
    {
        return KpiIndicator::query()->orderByDesc('created_at');
    }
