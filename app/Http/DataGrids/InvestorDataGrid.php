...
use App\Http\Resources\Investor\InvestorResource;
use App\Model\Investor;
use Illuminate\Http\Request;

class InvestorDataGrid extends QueryDataGrid
{
    protected $resource = InvestorResource::class;
    ...
    {
        return Investor::query()->with('organization.country',
                                        'organization.city',
