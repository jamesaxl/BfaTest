...
use App\Http\Resources\Government\GovernmentResource;
use App\Model\Government;
use Illuminate\Http\Request;

class GovernmentDataGrid extends QueryDataGrid
{
    protected $resource = GovernmentResource::class;
    ...
    {
        return Government::query()->with('organization.country',
                                        'organization.city',
